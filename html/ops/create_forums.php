...
create_forum($catid, 0, "News", "project news", 1);
...
create_forum($catid, 0, "Windows", "Running BOINC on Windows");
create_forum($catid, 1, "Unix/Linux", "Running BOINC on Unix and Linux");
